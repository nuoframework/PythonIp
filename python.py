...
if opcionales1 == "A":
    ...
    os.system("python C:/Users/viruz/Desktop/ESCRITORIO/Github/Python/PythonIp/main.py")
elif opcionales1 == "C":
    os.system("python C:/Users/viruz/Desktop/ESCRITORIO/Github/Python/PythonIp/python2.py")
else:
    SystemError
